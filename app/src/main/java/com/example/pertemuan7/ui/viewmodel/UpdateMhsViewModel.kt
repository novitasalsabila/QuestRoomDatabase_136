...
import com.example.pertemuan7.ui.navigation.DestinasiUpdate
...
class UpdateMhsViewModel(
    ...
    init {
        viewModelScope.launch{
            updateUiState = repositoryMhs.getMhs(_nim).filterNotNull().first().toUiStateMhs()
        }
    }
    ...
    fun updateData(){
        ...
        if(validateFields()){
            ...
            updateUiState = updateUiState.copy(
                snackBarMessage = "Data gagal dihapus"
            )
        }
    }
